...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(auth)/login/` | `/login/` | `/(auth)/login` | `/(auth)/register/` | `/register/` | `/(auth)/register` | `/(tabs)/add/` | `/add/` | `/(tabs)/add` | `/(tabs)/cases/` | `/cases/` | `/(tabs)/cases` | `/(tabs)/` | `/(tabs)` | `/(tabs)/settings/` | `/settings/` | `/(tabs)/settings`;
  // prettier-ignore
